...
export default class EditMultipleTextBoxQuestion  extends Component {
    constructor(props){
        super(props);
        this.state={
            control:{
    ...
    render () {
        ...
        return (
            <EditQuestion type='multiple_text_box' className='edit-multiple-choice' onRemove={this.handleRemove.bind(this)}
...
EditMultipleTextBoxQuestion.propTypes =  {
