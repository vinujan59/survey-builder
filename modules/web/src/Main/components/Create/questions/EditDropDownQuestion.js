...
export default class  EditDropDownQuestion extends Component {
    constructor(props){
        super(props);
        this.state={
            control:{
    ...
    render () {
        ...
        return (
            <EditQuestion type='drop_down' className='edit-multiple-choice' onRemove={this.handleRemove.bind(this)}
...
EditDropDownQuestion.propTypes =  {
